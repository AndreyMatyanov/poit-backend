...
class CRUDBase(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    ...
    def update(self, db: Session, *,
        ...
        if self._updated_at_field in self.model.__dict__ and self._updated_at_field not in update_data:
    ...
    def update_multi(self, db: Session, *, ids: list[Union[int, UUID]], obj_in: UpdateSchemaType) -> None:
